...
* Postgresql db management:
  ...
  * `sudo createuser -D -R -S catalog`  // create new postgres role 'catalog'. -No database creation, -No role creation, -Not superuser.
  ...
  * Note - 3 'catalog' names in use:
    ...
    * postgresql role 'catalog'.  Cannot create db, cannot create role, not super user.
